...
#### cors란?
   ...
   3. Same Origin Policy
      브라우저가 동일 출처 정책(SOP)으로 인해 다른 출처의 리소스 접근을 금지시키는 것.
       - 외부 리소스를 가져오지 못하는 단점
       - XSS 등과 같은 보안 취약점을 사전에 방지할 수 있음.
   ...
   4. CORS(Cross Origin Resource Sharing)
     ...
     response  <--------------
         ...
         조건:
          ...
          - Content-Type 헤더에 application/x-www-form-urlencoded, multipart/for-data, text/plain인 경우
