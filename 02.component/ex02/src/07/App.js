    ...
    return (
        <Fragment>
            ...
            <Modal
                ...
                onRequestClose={ () => setModal02IsOpen(false) }        // modal 창 바깥을 눌러도 꺼진다.
            ...
            <Modal
                ...
                shouldCloseOnOverlayClick={ true }                      // overlay 클릭을 controll, true면 누르면 꺼짐, false면 눌러도 안꺼짐
            ...
            <Modal
                ...
                overlayClassName={ styles.Overlay }             // 클래스로 css 적용
